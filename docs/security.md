...
**Versão:** 0.2.6-beta (790 testes; free-list + riscv64; `kof.http` JVM+JS + retry/circuit)
...
# 7. ESTADO DA IMPLEMENTAÇÃO (0.2.6-beta, 31/08/2026 — `VERSION` 0.2.6-beta, 790 testes, free-list + riscv64)
