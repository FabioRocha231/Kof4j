...
> Tabela reflete 0.2.6-beta (03/09) — Build `mvn test` **(re-medir após merge; branch idiomatic-fixes 819 em 02/09)** , golden 16/16, integration 9/9. DoD em `docs/plan-platform-completion.md`.
