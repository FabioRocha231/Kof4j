...
| `web.app()` WebSocket `app.ws` + SSE `sse.*` | ✅ JVM (RFC 6455 frames/fragmentação/close/handshake + hardening; BINARY `1003`) | WEB004/WEB003 | WEB004/WEB003 | `KofWebWsE2ETest` 28/28 · `KofWebSseE2ETest` 10/10 · `KofWsFrameTest` 7/7 |
