...
> Tabela reflete 0.2.6-beta (01/09) — Build `mvn test` **780** (763+8+5+4), golden 16/16, integration 9/9. DoD em `docs/plan-platform-completion.md`.
