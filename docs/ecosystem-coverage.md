...
> **Build:** `mvn clean package` PASS, `mvn test` 658 (650 kof-compiler +8 kof-script +5 kof-c-compiler), golden 16/16, integration 9/9, `scripts/package.sh` PASS, `VERSION` 0.2.6-beta, `release.yml` 2 jobs (`test-and-bump` → `package-and-release`) × 3 plataformas, Windows SIGPIPE fix.
