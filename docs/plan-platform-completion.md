...
| 🟡 Config/Log Native *(LOG001 ✅ feito 0.0.14)* | `kof.log` Native completo (asm: data civil, env scan próprio, stderr); falta `kof.config` no Native e `KOF_LOG_JSON` nativo | LOG001 ✅; CONFIG001 ✅ (precedência completa, typed; NativeConfigE2ETest 8/8) |
