...
| WEB001 | kof.web JS | 🟡 EM CURSO — about the descr: no longer mock front. JaBackend possui `kofWebstub` correspondentes; draft5 em desenv (tratarent dispatch | ambito pendente) |
