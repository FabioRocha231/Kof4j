...
|---|---|---|---|---|---|
| **Bug-hunt + `known-bugs.md`** | `EM CURSO` | agente-idiomatic | idiomatic-fixes | `docs/known-bugs.md`, `docs/status.md` | 23 bugs documentados (02-03/09). Corrigir bug = reivindicar aqui primeiro e fix no código, não no corpus. |
